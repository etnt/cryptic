...
COPY scripts/docker-admin-bootstrap.sh /usr/local/bin/bootstrap-admin
RUN chmod +x /usr/local/bin/docker-entrypoint.sh /usr/local/bin/generate-mtls-certs.sh /usr/local/bin/bootstrap-admin
