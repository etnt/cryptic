...
complete_room_workflow_test_() ->
    {setup, fun setup/0, fun cleanup/1, fun(
        {TestUser1, TestUser2, _Prekey1, _Prekey2}
    ) ->
        [
            ...
            ?_test(begin
                ...
                Response1 = cryptic_room_handlers:handle_room_command(
                    create_room, CreateCommand, TestUser1
                ),
            ...
            ?_test(begin
                ...
                CreateResponse = cryptic_room_handlers:handle_room_command(
                    create_room, CreateCommand, TestUser1
                ),
                ...
                JoinResponse = cryptic_room_handlers:handle_room_command(
                    join_room, JoinCommand, TestUser2
                ),
                ...
                MessageResponse = cryptic_room_handlers:handle_room_command(
                    send_room_message, MessageCommand, TestUser1
                ),
                ?assertMatch(
                    #{success := true, message_id := _}, MessageResponse
                ),
            ...
            ?_test(begin
                ...
                cryptic_room_handlers:handle_room_command(
                    create_room, CreateCommand1, TestUser1
                ),
                cryptic_room_handlers:handle_room_command(
                    create_room, CreateCommand2, TestUser1
                ),

                % List rooms
                ListCommand = #{<<"type">> => <<"list_rooms">>},
                ListResponse = cryptic_room_handlers:handle_room_command(
                    list_rooms, ListCommand, TestUser1
                ),

                ?assertMatch(#{success := true, rooms := _}, ListResponse),
                #{rooms := Rooms} = ListResponse,
                % May have rooms from other tests
            ...
            ?_test(begin
                ...
                LeaveResponse = cryptic_room_handlers:handle_room_command(
                    leave_room, LeaveCommand, TestUser2
                ),
...
error_handling_test_() ->
    {setup, fun setup/0, fun cleanup/1, fun(
        {TestUser1, _TestUser2, _Prekey1, _Prekey2}
    ) ->
        [
            ...
            ?_test(begin
                ...
                Response = cryptic_room_handlers:handle_room_command(
                    join_room, JoinCommand, TestUser1
                ),
