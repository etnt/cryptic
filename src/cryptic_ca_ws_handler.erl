...
handle_command(_Msg, State) ->
    ErrorResp = jsx:encode(#{
        ...
        message =>
            <<"Supported commands: register_user, list_users, get_user_info, suspend_user, revoke_user, reactivate_user, cert_status_query, cert_renew, gpg_register_bootstrap">>
    }),
    {reply, {text, ErrorResp}, State}.
